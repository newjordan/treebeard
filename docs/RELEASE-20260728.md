...
See [CLAIMS.md](CLAIMS.md). **No flash.** Every number below names its test and artifact.

**Not claimed:** “94-verified server,” smarter model, multi-slot as solo chat speed.
