...
explicitly authorized. Residual builtins: scan fixture + diagnose retry_hint (tip 87e6e6ca4). Shadow: adversarial 5/5, recovery 6/6 (retry_hint multi-probe), hard-v2 n=2 pass=1.0; post-retryhint cool-down hard=1.0 ABA p50≈28.3 heldout 43/46, miner + preference export; Hosted freeze without spend. Reasoning
