...
[agent benchmark report](https://newjordan.github.io/treebeard/).
...
- `nvidia/attribution-q8`: seven-wave Q8_0 candidate/fallback attribution;
...
Raw artifacts may contain historical aliases and local collection paths. They
are intentionally unchanged so their published hashes remain meaningful; the
current project identity is Treebeard.
