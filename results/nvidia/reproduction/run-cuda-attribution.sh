...
OUT=${TREEBEARD_NVIDIA_OUT:-$ROOT/evidence/attribution}

mkdir -p "$OUT"
nvidia-smi -q > "$OUT/nvidia-smi-before.txt"

mat='^type_a=q8_0,type_b=f32,m=512,n=12,k=256,bs=\[1,1\],nr=\[1,1\],per=\[0,1,2,3\],k_v=0,o=1$'
mmid='^(type_a=q5_K,type_b=f32,n_mats=256,n_used=8,b=1,m=512,n=12,k=2048|type_a=q6_K,type_b=f32,n_mats=256,n_used=8,b=1,m=512,n=12,k=2048|type_a=q6_K,type_b=f32,n_mats=256,n_used=8,b=0,m=2048,n=12,k=512|type_a=q8_0,type_b=f32,n_mats=256,n_used=8,b=0,m=2048,n=12,k=512)$'
...
sha256sum "$OUT"/wave-*.log > "$OUT/attribution.sha256"
